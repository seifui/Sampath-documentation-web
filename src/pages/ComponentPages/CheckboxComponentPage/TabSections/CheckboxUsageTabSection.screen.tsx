      ...
      <div className="mt-14  text-primary dark:text-primary-dark">
        ...
        <div id="Anatomy">
          ...
          <p>
            ...
            options independently. Unlike radio buttons, checkboxes do not
            enforce a single-selection rule - each option can be toggled on or
            off without affecting others in the group. This control is ideal for
        ...
        <div id="Sizes">
          ...
          <p className="mb-3">
            ...
            thoughtfully crafted to maintain clear visibility, comfortable
            interaction, and consistent alignment within various UI components.
        ...
        <div id="States">
          ...
          <p className="mb-3">
            ...
            accessibility. The default state allows users to select or deselect
            an option, the focused state provides visual feedback to indicate
        ...
        <div id="Variants">
          ...
          <p className="mb-3">
            ...
            options horizontally for compact spaces, while the multi-row variant
