...
export function ProgressStepsCodeTabSection() {   
    return (
        <div className="max-w-[820px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            ...
            {/* React */}
            <a href="https://storybook-ds-guide.netlify.app/?path=/docs/subframe-radiocardgroup--docs" target="_blank" rel="noopener noreferrer" className="border rounded-lg p-6 flex flex-col justify-between hover:bg-gray-50 transition cursor-pointer">
