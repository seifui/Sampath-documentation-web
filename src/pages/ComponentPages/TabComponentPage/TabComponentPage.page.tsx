...
import { TabUsageTabSection } from "./TabSections/TabUsageTabSection.screen";
import { TabCodeTabSection } from "./TabSections/TabCodeTabSection.screen";

export function TabComponentPage() {
  ...
  return (
    <section className="w-full">
      <div className="w-full">
        <PageHeader
          heading="Tabs"
          content="A component used to organize related content into multiple sections, allowing users to switch between views efficiently without leaving the current page."
        />
