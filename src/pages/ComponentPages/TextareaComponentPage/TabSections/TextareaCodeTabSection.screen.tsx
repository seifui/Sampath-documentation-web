    ...
    <div className="max-w-[820px] mx-auto">
      <div id="Documentation" className="mt-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
          ...
          {/* React */}
          <a href="http://localhost:62741/?path=/docs/components-textarea--docs" target="_blank" rel="noopener noreferrer" className="border rounded-lg p-6 flex flex-col justify-between hover:bg-gray-50 transition cursor-pointer">
