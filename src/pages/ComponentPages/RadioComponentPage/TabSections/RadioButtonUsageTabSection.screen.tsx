      ...
      <div className="mt-14  text-gray-700 dark:text-gray-dark-700">
        ...
        <div id="Sizes">
          ...
          <p className="mb-3">
            ...
            small size is ideal for compact layouts or dense UI elements,
            ensuring a minimal footprint without compromising usability. The
            medium size provides a more prominent selection area, improving
        ...
        <div id="Property">
          ...
          <p className="mb-3">
            ...
            accessibility. The default state shows the unselected option, the
            hover state provides visual feedback before interaction, the focused
            state highlights keyboard or assistive-tech navigation, and the
