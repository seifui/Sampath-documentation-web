...
import { LinkUsageTabSection } from "./TabSections/LinkUsageTabSection.screen";
import { LinkCodeTabSection } from "./TabSections/LinkCodeTabSection.screen";

export function LinkComponentPage() {
    ...
    <>
      <section className="w-full">
        <div className="w-full">
          <PageHeader
            heading="Link"
            content="A component that creates a navigable hyperlink to other pages or resources."
          />
